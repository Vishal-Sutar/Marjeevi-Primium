...
const Screen5 = () => {
  ...
  // ✅ data from Screen4
  const { screen4Data, themeColor = "#2E7D32" } = route.params || {};
...
const renderSoilItem = ({ item }) => (
  ...
  const handleContinue = () => {
    ...
    navigation.navigate("Screen6", { finalPayload, themeColor });
  };
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.card}>
        <View style={[styles.iconWrapper, { backgroundColor: `${themeColor}20` }]}>
          <Icon name="home-outline" size={20} color={themeColor} />
        </View>
